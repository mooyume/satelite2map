if __name__ == '__main__':
    ...
    from network import init_G, init_D
    ...
    for epoch in range(config['NUM_EPOCHS']):
        ...
        # save_some_examples(gen, val_loader, config['NUM_EPOCHS'], folder='./examples')
        save_some_examples(gen, val_loader, epoch, folder='./examples')
